...
<div id="container">
  ...
  <div id="navcontainer">
    ...
    |
	  <span class="style11">........ .</span>|<a href="../login/daftar.php" class="style1"style1">DAFTAR</a> | <a href="../login/login.php" class="style1"style1">LOGIN</a>
    </ul>
  </div>
  <div id="sidebar">
    <h2>Menu</h2>
    <div class="navlist">
      <ul>
        ...
        <li><a href="pengembalian.php"><span class="style9">Lihat</span> <span class="style9">Pengembalian</span></a></li>

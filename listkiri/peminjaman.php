  ...
  <div id="sidebar">
    ...
    <div class="navlist">
      <ul>
        ...
        <li><a href="peminjaman.php"><span class="style9">Tambah</span> <span class="style9">Peminjaman</span> </a></li>
...
include "../db_peminjaman/koneksi1.php";
?>
        <br>
      MENAMPILKAN PEMINJAMAN YANG TELAH DI INPUT
      <table Width='532'  border='1' align="center" >  
<tr>
	<th width="28"> NO </th>
	<th width="75"> Nama </th>
	<th width="93"> Kode Buku </th>
	<th width="81"> Judul Buku </th>
	<th width="107">Tanggal Peminjaman</th>
	<th width="108">Tanggal Pengembalian</th>
...
<p>
  <!-- /////////////////////////////tombol untuk menambah data//////////////////////////////////--></p>
<form action='../db_peminjaman/tambah.php' method='POST'>
<table >
	<tr>

...
<div id="container">
  ...
  <div id="navcontainer">
    <ul id="navlist">
      ...
      <a href="../admin/sl_about.html"><span class="style1">LOCATION</span>
      </li></a> |
  ...
  <div id="sidebar">
    ...
    <div class="navlist">
      <ul>
        <li><a href="anggota.php"><span class="style9">Tambah</span> <span class="style9">Anggota</span> </a></li>
...
<p>&nbsp; </p>
<form action='../db_anggota/tambah.php' method='POST'>
<table >
	<tr>
	<td> <input type='submit' name='tambah' value='Tambah Anggota'> </td>	
	</tr>
</table>
</form>
	  <p>&nbsp;</p>

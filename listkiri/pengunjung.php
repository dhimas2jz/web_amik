  ...
  <div id="sidebar">
    ...
    <div class="navlist">
      <ul>
        ...
        <li><a href="pengembalian.php">Tambah Pengembalian</a></li>
        <li><a href="pengunjung.php"><span class="style9">Tambah</span> <span class="style9">Pengunjung</span></a></li>
      </ul>
    </div>
    <h2>Link</h2>
    <div class="navlist">
...
include "../db_pengunjung/koneksi1.php";
?>
        <br>
...
<tr>
	<th width="28"> NO </th>
	<th width="88"> Nama Pengunjung </th>
	<th width="87">Tanggal </th>
	<th width="97">Status </th>
	<th width="98">Buku Yang Di Lihat</th>
	<th width="94">Email</th>
</tr>
 
<?php  
// Perintah untuk menampilkan data
$queri="Select * From pengunjung" ;  //menampikan SEMUA data dari tabel siswa
...
<p>&nbsp; </p>
<form action='../db_pengunjung/tambah.php' method='POST'>
<table >
	<tr>
	<td> <input type='submit' name='tambah' value='Tambah Pengunjung'> </td>	
	</tr>
</table>
</form>
	  <p>&nbsp;</p>
